...
public class DataReaderHibernate2NF implements IQuery{
	...
	public List<Result> getNoOfEnrollmentsForAgencies() {
		return execute(Constants.HBN_2NF_GET_NO_OF_ENROLLMENTS_FOR_AGENCIES,"getNoOfEnrollmentsForAgencies" );
	}

	public List<Result> getNoOfRejectionsForAgencies() {
		return execute(Constants.HBN_2NF_GET_NO_OF_REJECTIONS_FOR_AGENCIES,"getNoOfRejectionsForAgencies");
	}

	public List<Result> getNoOfSeniorCitizensEnrolledGroupedByGender() {
		return execute(Constants.HBN_2NF_GET_NO_OF_SENIOR_CITIZENS_ENROLLED_GROUP_BY_GENDER, "getNoOfSeniorCitizensEnrolledGroupedByGender");
	}

	public List<Result> getNoOfAadhaarUsersProvidingPhoneGroupedByState() {
		return execute(Constants.HBN_2NF_GET_NO_OF_USERS_PROVIDING_PHONE_NUMBER_GROUP_BY_STATE,"getNoOfAadhaarUsersProvidingPhoneGroupedByState");
	}
	...
	public List<Result> getNoOfAadhaarGeneratedForDateRangeGroupedByState(
		...
		return execute(Constants.HBN_2NF_GET_NO_OF_ENROLLMENTS_FOR_DATE_RANGE_GROUP_BY_STATE, "GetNoOfAadhaarGeneratedForDateRangeGroupedByState"
				, startDt, endDt);
	}
